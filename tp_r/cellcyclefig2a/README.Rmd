...
authentification (un compte gratuit suffit : <https://ossindex.sonatype.org>).
Sans identifiants, l'API renvoie une erreur HTTP 401. Une fois le jeton obtenu :
...
Les dependances runtime (`ggplot2`, `scales`, `rlang`) sont des paquets CRAN
courants et a jour, sans avis de securite connu.
